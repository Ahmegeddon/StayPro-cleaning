        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            <motion.div
              ...
              <span className="flex items-center gap-1 text-cyan-700 text-sm font-medium">
                Abu Dhabi's Premier Short-Term Rental Management
              </span>
            </motion.div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight tracking-tight">
              The Complete Airbnb &{' '}
              <span className="text-cyan-600">Short-Term Rental Solution</span>
            </h1>

            <p className="mt-6 text-lg sm:text-xl text-slate-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
              From professional turnover cleaning to full property management — we handle 
              every aspect of your rental so you earn more and stress less.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0">
              {[
                { icon: TrendingUp, label: 'Revenue Optimized' },
          ...
          <motion.div
            ...
            <motion.div
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-semibold text-slate-900">+35% Revenue</p>
                  <p className="text-sm text-slate-500">Average increase</p>
                </div>
              </div>
