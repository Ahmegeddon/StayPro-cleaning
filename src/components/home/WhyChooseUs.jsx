        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-slate-900 leading-tight">
              The Cleaning Partner Your Rental Business Deserves
            </h2>
            <p className="mt-5 text-lg text-slate-600 leading-relaxed">
              We're not just cleaners — we're your partners in maintaining guest satisfaction 
              and protecting your rental investment. Our specialized approach ensures every 
              property is guest-ready.
            </p>
